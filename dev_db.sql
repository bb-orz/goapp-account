...
CREATE TABLE `oauth` (
  ...
  `open_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '开发者可通过OpenID来获取用户基本信息',
  `union_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '如果开发者拥有多个移动应用、网站应用和公众帐号，可通过获取用户基本信息中的unionid来区分用户的唯一性，因为只要是同一个微信开放平台帐号下的移动应用、网站应用和公众帐号，用户的unionid是唯一的。',
  `nick_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '三方平台账号的用户昵称',
  `gender` tinyint unsigned DEFAULT NULL COMMENT '用户性别：1男2女',
...
CREATE TABLE `user` (
  ...
  `email_verified` tinyint unsigned DEFAULT '0' COMMENT '邮箱是否已验证',
  `phone` char(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '账户手机号码',
  `phone_verified` tinyint unsigned DEFAULT '0' COMMENT '手机号码是否已验证',
  `password` char(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户已加密密码字符串',
  `salt` char(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '加密盐',
  `status` tinyint unsigned DEFAULT '0' COMMENT '账户状态：0：未验证，1：已验证，2：已停用',
