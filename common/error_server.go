...
const (
	// 服务端错误顶层包装信息格式
	ServerInnerErrorFormat	       = "[Server Inner Error]: Domain:%s"
...
func ServerErrorWrapper(err error, messageFormat string, msgArgs ...interface{}) SError {
	return SError{
		Inner:      err,
...
// 服务端错误顶层包装信息包装方法
func ServerInnerError(err error,domain string) SError {
	return ServerErrorWrapper(err,ServerInnerErrorFormat,domain)
}

// sql查询错误包装方法
func DomainInnerErrorOnSqlQuery(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnSqlQueryFormat,method)
}
// sql插入错误包装方法
func DomainInnerErrorOnSqlInsert(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnSqlInsertFormat,method)
}

// sql更新错误包装方法
func DomainInnerErrorOnSqlUpdate(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnSqlUpdateFormat,method)
}

// sql删除错误包装方法
func DomainInnerErrorOnSqlDelete(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnSqlDeleteFormat,method)
}

// sql假删除错误包装方法
func DomainInnerErrorOnSqlShamDelete(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnSqlShamDeleteFormat,method)
}


// nosql查询错误包装方法
func DomainInnerErrorOnNoSqlQuery(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnNoSqlQueryFormat,method)
}

// nosql插入错误包装方法
func DomainInnerErrorOnNoSqlInsert(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnNoSqlInsertFormat,method)
}

// nosql更新错误包装方法
func DomainInnerErrorOnNoSqlUpdate(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnNoSqlUpdateFormat,method)
}

// nosql删除错误包装方)
func DomainInnerErrorOnNoSqlDelete(err error,method string) SError {
	return ServerErrorWrapper(err,ErrorOnNoSqlDeleteFormat,method)
}

// nosql假删除错误包装方法
func DomainInnerErrorOnNoSqlShamDelete(err error,method string) SError {
